...
import {assessPrototype,prototypePanel} from './challenges/prototype-rules.js';
...
function showScoreInspection(){
 ...
 for(const tile of $('plane').querySelectorAll('.quality-colored')){tile.classList.remove('quality-colored');tile.style.removeProperty('--quality-color');delete tile.dataset.qualityTier;}
