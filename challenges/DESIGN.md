...
Each prototype has a finite, visible manifest—138, 269, and 257 words respectively. These are ordinary words and inflections filtered by the exact bank, rather than a manifest restricted to the witness's seven or eight runs. There are no two-letter words. The same fixed allowlist governs auto-check and acceptance; personal dictionary overrides do not modify a work order.
